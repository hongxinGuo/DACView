...
CDlgDivide::CDlgDivide(CWnd* pParent /*=nullptr*/)
  : CDialog(CDlgDivide::IDD, pParent)
{
  //{{AFX_DATA_INIT(CDlgDivide)
  m_strComment = "";
  m_eHiLimit = 10000.0;
  m_eHiRange = 10000.0;
  m_eK1 = 1.0;
...
void CDlgDivide::DoDataExchange(CDataExchange* pDX)
{
  CDialog::DoDataExchange(pDX);
  //{{AFX_DATA_MAP(CDlgDivide)
...
BEGIN_MESSAGE_MAP(CDlgDivide, CDialog)
  //{{AFX_MSG_MAP(CDlgDivide)
    // NOTE: the ClassWizard will add message map macros here
  //}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CDlgDivide::SetData(CString name, double K1, double K2, double HiRange,
...
void CDlgDivide::GetData(CString& name, double& K1, double& K2, double& HiRange,
