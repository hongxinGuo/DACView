...
CDlgMSel::CDlgMSel(CWnd* pParent /*=nullptr*/)
  : CDialog(CDlgMSel::IDD, pParent)
{
  //{{AFX_DATA_INIT(CDlgMSel)
  m_strComment = "";
  m_eHiLimit = 10000.0;
  m_eHiRange = 10000.0;
  m_eLoLimit = 0.0;
...
void CDlgMSel::DoDataExchange(CDataExchange* pDX)
{
  CDialog::DoDataExchange(pDX);
  //{{AFX_DATA_MAP(CDlgMSel)
...
BEGIN_MESSAGE_MAP(CDlgMSel, CDialog)
  //{{AFX_MSG_MAP(CDlgMSel)
          // NOTE: the ClassWizard will add message map macros here
  //}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CDlgMSel::SetData(CString name, double HiRange, double LowRange, double HiLimit, 
...
void CDlgMSel::GetData(CString& name, double& HiRange, double &LowRange, double& HiLimit,
