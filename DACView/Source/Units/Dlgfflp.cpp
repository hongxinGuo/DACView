...
CDlgFFLP::CDlgFFLP(CWnd* pParent /*=nullptr*/)
        : CDialog(CDlgFFLP::IDD, pParent)
{
        //{{AFX_DATA_INIT(CDlgFFLP)
        m_fAlarmHigh = FALSE;
...
void CDlgFFLP::DoDataExchange(CDataExchange* pDX)
{
        CDialog::DoDataExchange(pDX);
        //{{AFX_DATA_MAP(CDlgFFLP)
...
BEGIN_MESSAGE_MAP(CDlgFFLP, CDialog)
        //{{AFX_MSG_MAP(CDlgFFLP)
                // NOTE: the ClassWizard will add message map macros here
        //}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CDlgFFLP::SetData(CString name, bool enableAlarm, bool alarmHigh,
...
void CDlgFFLP::GetData(CString& name, bool& enableAlarm, bool& alarmHigh,
