...
CDlgOr::CDlgOr(CWnd* pParent /*=nullptr*/)
  : CDialog(CDlgOr::IDD, pParent)
{
  //{{AFX_DATA_INIT(CDlgOr)
  m_fAlarmHigh = FALSE;
  m_strComment = "";
  m_strName = "";
...
void CDlgOr::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgOr, CDialog)
  //{{AFX_MSG_MAP(CDlgOr)
    // NOTE: the ClassWizard will add message map macros here
  //}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CDlgOr::SetData(CString name, bool enableAlarm, bool alarmHigh, double scanrate,
                       CString comment) {
  m_strName = name;
...
void CDlgOr::GetData(CString& name, bool& enableAlarm, bool& alarmHigh, INT32& scanrate,
                     CString& comment) {
  name = m_strName;
