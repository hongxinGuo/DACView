...
class CDlgSetMeterProperty : public CDialog
{
// Construction
public:
	CDlgSetMeterProperty(CWnd* pParent = nullptr);	// standard constructor
  void Init( CObjectBase * pcobj );
  
// Dialog Data
	//{{AFX_DATA(CDlgSetMeterProperty)
	enum { IDD = IDD_OBJECT_METER };
