...
#undef THIS_FILE
  ...
  TEST(TestCUnitComponent, TestInitialize) {
    ...
    EXPECT_STREQ(_T("UnitComponent"), c.GetName());
  ...
  TEST(TestCUnitComponent, TestSerialize) {
    ...
    EXPECT_STREQ(_T("Para3"), pc2->GetParaName(3));
  ...
  TEST(TestCUnitComponent, TestSetString) {
    ...
    c.SetString(1, "abc");
    EXPECT_STREQ(_T("abc"), c.GetString(1));
...
*/
  ...
  TEST(TestCUnitComponent, TestGetParaSrcUnit) {
    ...
    EXPECT_STREQ(_T("abc"), pc->GetName());
  }
